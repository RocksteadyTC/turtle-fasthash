...
const uint32_t UPGRADE_HEIGHT_V4                             = 4; // Upgrade height for CN_Turtle2x switch.
...
const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "turtle2x_blocks.bin";
const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "turtle2x_blockindexes.bin";
const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "turtle2x_poolstate.bin";
const char     P2P_NET_DATA_FILENAME[]                       = "turtle2x_p2pstate.bin";
const char     MINER_CONFIG_FILE_NAME[]                      = "turtle2x_miner_conf.json";
} // parameters

const char     CRYPTONOTE_NAME[]                             = "turtle2x_TurtleCoin";
...
{
    {  0xaa, 0xbb, 0x4a, 0x6c, 0xcf, 0x52, 0x57, 0x41, 0x65, 0xf9, 0x91, 0xa4, 0xb6, 0xc1, 0x43, 0xe9  }
};

const char* const SEED_NODES[] = {
  "165.227.11.59:11897", // 01
  "142.93.17.44:11897" // 02
};
} // CryptoNote
